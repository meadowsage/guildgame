...
public class Main0030 extends Scenario {
    ...
    public List<ScenarioScript> getScripts() {
        ...
        return Arrays.asList(
                ...
                , eris.speak("クエストの難易度は場所によって変化します。受注する冒険者のスキルには気を配るようにしてください。")
                , eris.speak("冒険者の能力に不安がある場合は、複数人でクエストに参加するのも良いでしょう。参加者が多いほどクエストの成功率は上がります。")
                , eris.speak("＜画像＞それから、場所にはそれぞれ『探索度』というパラメータが存在します。")
                , eris.speak("探索度は、その場所をどれくらい調べ終わったかを表す割合です。１００％になったとき、その場所の最深部まで到達したということになります。")
                , eris.speak("探索度は主に『探索』クエストによって上昇します。探索が完了すると、何かしらのボーナスやイベントがあるかもしれませんね。")
        );
    }
}
