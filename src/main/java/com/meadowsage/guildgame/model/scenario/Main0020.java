...
public class Main0020 extends ScenarioBase {
    ...
    public List<ScenarioContent> getContents() {
        ...
        return Arrays.asList(
                ...
                , me.speak("なんのことだろう。エリフさんは昨日、説明を終えるなりどこかに行ってしまったのだが、何か相談でもしていたのだろうか")
                , elif.speak("支部長")
                , me.speak("……ああ、私のことか")
                , elif.speak("今日は新しい冒険者の登録業務を覚えてもらいます")
                , me.speak("登録？")
                ...
                , elif.speak("今はとにかく人手が足りません。余程のことがない限り、今日来る予定の申請は承認してください")
                , me.speak("わかった、そうしよう")
        );
    }
}
